...
struct BufferElement {
	...
	uint32_t GetComponentCount() const {
		switch (Type) {
			...
			case ShaderDataType::Mat2:   return 2 * 2; // could be just 2
			case ShaderDataType::Mat3:   return 3 * 3; // could be just 3
			case ShaderDataType::Mat4:   return 4 * 4; // could be just 4

...
void EditorCamera::UpdateView()
{
	...
	// current configuration orbits camera around focal point.
	// Inversing camera view will have the effect of spinning the camera around.
}
...
{
	if (Input::IsKeyHeld(GLFW_KEY_LEFT_ALT))
	{
